...
Query::Abstract - Create filters in Perlish way and transform them into coderefs or SQL
...
L<Query::Abstract> - allows you to write queries and then tranform. Queries are almost compatible with Rose::DB::Object queries. 
This module apperared because I wanted to have SQL independent queries but with ability to convert in SQL(or other format).

Now this module has two standard drivers - ArrayOfHashes and SQL.(You can write your own)
